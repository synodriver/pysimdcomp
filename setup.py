...
c_sources = ["simdcomp/backends/cython/_simdcomp.pyx"] + glob.glob("./dep/src/*.c")
...
def get_version() -> str:
    path = os.path.join(
        os.path.abspath(os.path.dirname(__file__)), "simdcomp", "__init__.py"
    )
...
def main():
    ...
    setup(
        name="simdcomp",
        version=version,
        url="https://github.com/synodriver/pysimdcomp",
        packages=packages,
        keywords=["simdcomp"],
        description="python binding for simdcomp",
